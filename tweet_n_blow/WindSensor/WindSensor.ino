...
void loop() {
  ...
  if (millis() - lastMillis > 30){      // read every 200 ms - printing slows this down further
...
//    Serial.println((float)WindSpeed_MPH);
    int windSpeed = WindSpeed_MPH;
    Serial.write(windSpeed);
  ...
  redBrightness = map(WindSpeed_MPH, 2.0, 30.0, 0.0, 255.0);
  ...
  if (redBrightness < 0) {
    ...
    analogWrite(11, HIGH); 
    analogWrite(10, redBrightness / 3); 
  }
  else {
      analogWrite(11, redBrightness);
      analogWrite(10, redBrightness / 3);
  }
